...
ThemeClass::ThemeControl ThemeClass::_themes[THEME_COUNT] = {
    {"AIRSTRIK", TXT_THEME_AIRSTRIKE, "Air Strike", 0, 200, false, false, false, true},
    {"80MX226M", TXT_THEME_80MX, "C&C 80's Mix", 0, 248, false, false, false, true},
    {"CHRG226M", TXT_THEME_CHRG, "Depth Charge", 0, 256, true, false, false, true},
    {"CREP226M", TXT_THEME_CREP, "Creeping Upon", 0, 222, true, false, false, true},
    {"DRIL226M", TXT_THEME_DRIL, "Drill", 0, 272, true, false, false, true},
    {"DRON226M", TXT_THEME_DRON, "Drone", 0, 275, true, false, false, true},
    {"FIST226M", TXT_THEME_FIST, "Iron Fist", 0, 212, true, false, false, true},
    {"RECN226M", TXT_THEME_RECON, "Recon", 0, 261, true, false, false, true},
    {"VOIC226M", TXT_THEME_VOICE, "Voice Rhythm", 0, 306, true, false, false, true},
    {"HEAVYG", TXT_THEME_HEAVYG, "Demolition", 0, 180, true, false, false, true},
    {"J1", TXT_THEME_J1, "Untamed Land", 4, 187, true, false, false, true},
    {"JDI_V2", TXT_THEME_JDI_V2, "Take 'em Out", 5, 183, true, false, false, true},
    {"RADIO", TXT_THEME_RADIO, "Radio", 6, 183, true, false, false, true},
    {"RAIN", TXT_THEME_RAIN, "Rain In The Night", 7, 156, true, false, false, true},
    {"AOI", TXT_THEME_AOI, "Act On Instinct", 0, 168, true, true, false, true},
    {"CCTHANG", TXT_THEME_CCTHANG, "C&C Thang", 12, 193, true, false, false, true},
    {"DIE", TXT_THEME_DIE, "Die!!", 11, 162, false, false, false, true},
    {"FWP", TXT_THEME_FWP, "Fight, Win, Prevail", 10, 53, true, false, false, true},
    {"IND", TXT_THEME_IND, "Industrial", 1, 175, true, false, false, true},
    {"IND2", TXT_THEME_IND2, "Canyon Chase", 1, 38, true, false, false, true},
    {"JUSTDOIT", TXT_THEME_JUSTDOIT, "Just Do It!", 9, 142, true, false, false, true},
    {"LINEFIRE", TXT_THEME_LINEFIRE, "In The Line Of Fire", 8, 125, true, false, false, true},
    {"MARCH", TXT_THEME_MARCH, "March To Doom", 7, 157, true, false, false, true},
    {"TARGET", TXT_THEME_TARGET, "Mechanical Man", 0, 173, true, false, false, true},
    {"NOMERCY", TXT_THEME_NOMERCY, "No Mercy", 2, 204, true, false, false, true},
    {"OTP", TXT_THEME_OTP, "On The Prowl", 3, 182, true, false, false, true},
    {"PRP", TXT_THEME_PRP, "Prepare For Battle", 4, 211, true, false, false, true},
    {"ROUT", TXT_THEME_ROUT, "Reaching Out", 12, 121, false, true, false, true},
    {"HEART", TXT_THEME_HEART, "Heartbreak", 5, 206, false, true, false, true},
    {"STOPTHEM", TXT_THEME_STOPTHEM, "Deception", 0, 190, true, false, false, true},
    {"TROUBLE", TXT_THEME_TROUBLE, "Looks Like Trouble", 6, 191, true, true, false, true},
    {"WARFARE", TXT_THEME_WARFARE, "Warfare", 0, 182, true, false, false, true},
    {"BEFEARED", TXT_THEME_BEFEARED, "Enemies To Be Feared", 13, 164, false, true, false, true},
    {"I_AM", TXT_THEME_IAM, "I Am", 6, 161, false, false, false, true},
    {"WIN1", TXT_THEME_WIN1, "Great Shot!", 0, 41, false, true, true, true},
    {"MAP1", TXT_THEME_WIN1, "Great Shot!", 0, 61, false, false, true, true},
    {"VALKYRIE", TXT_THEME_VALK, "Ride of the Valkyries", 0, 306, false, false, true, true},
};
    ...
    if (name && strlen(name) > 0) {
        ...
        */
        ...
        for (theme = THEME_FIRST; theme < THEME_COUNT; theme++) {
            if (stricmp(_themes[theme].orig, name) == 0) {
                return (theme);
            }
        }
